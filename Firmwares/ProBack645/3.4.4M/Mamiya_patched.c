...
uint32 camImageCaptureFinishedTime = 0;
bool   camImageCaptureFinished = false;
...
void cameraMessageMamiya(byte* msgReceived, byte* msgSent)
{
    ...
    if (msgReceived[0] == 1)
    {
        ...
        {
            camImageCaptureFinished = false;
            camImageCaptureFinishedTime = 0;
            shutterCloseTime = 0;
            if (shutterMode == SM_DIGITAL_LONG)
            {
